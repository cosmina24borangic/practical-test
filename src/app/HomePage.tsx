  ...
  return (
    <div className="p-4 space-y-6">
      <div className="flex justify-end gap-4 mb-4">
        <a href="/add-category" className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
          + Adaugă categorie
        </a>
        <a href="/add-product" className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition">
          + Adaugă produs
        </a>
      </div>
        ...
        {products.map(product => (
          <div key={product.id} className="border rounded p-4 shadow">
            ...
            <div className="flex gap-3 mt-4">
              <button onClick={() => handleEdit(product.id)} className="text-blue-600 underline">Editează</button>
              <button onClick={() => handleDelete(product.id)} className="text-red-600 underline">Șterge</button>
            </div>
          </div>
        ))}
      </div>
